...
With the Views for WPForms plugin, you can now display and edit form entries on the front end of your site. That’s right, no more logging into the backend to manage your form entries.
...
You can create a table view, list view, or datatable ([Pro feature](https://formviewswp.com/?utm_source=wordpress-plugin-repo)).
The plugin also allows you to add custom content before and after each View, and control the number of entries displayed per page.

== Demo ==
[Table View](https://demo.formviewswp.com/?utm_source=wordpress-plugin-repo)
[List View](https://demo.formviewswp.com/user-profiles/?utm_source=wordpress-plugin-repo)
[DataTable View](https://demo.formviewswp.com/datatable-view/?utm_source=wordpress-plugin-repo)
[Edit Entry Demo](https://demo.formviewswp.com/try-editing-wpforms-entries/?utm_source=wordpress-plugin-repo)
...
* Display using Shortcode on any page, post or custom post type.
* Compatible with Elementor. Add Views to any page using Elementor Widgets.
* Compatible with the new Gutenberg block editor. Add View to your page using the WPForms Views block.
* Fully supported and regular updates.

Get more features in [Pro version](https://formviewswp.com/pricing/?utm_source=wordpress-plugin-repo)
...
* [Display Entry details on Single Page](https://formviewswp.com/docs/how-to-display-entry-details-on-single-page/?utm_source=wordpress-plugin-repo)
* [Add Custom HTML field &amp; use WPForms Smart Tags inside View](https://formviewswp.com/docs/how-to-use-wpforms-smart-tags-in-custom-html-field/?utm_source=wordpress-plugin-repo)
* [Filter entries by field values or use Merge Tags](https://formviewswp.com/docs/how-to-filter-wpforms-entries-using-merge-tags/?utm_source=wordpress-plugin-repo)
* [Sort WPForms Entries via field values](https://formviewswp.com/docs/sort-wpforms-entries-by-field-value/?utm_source=wordpress-plugin-repo)
* [Display Only starred entries](https://formviewswp.com/how-to-display-wpforms-starred-viewed-entries-on-site-frontend/?utm_source=wordpress-plugin-repo)
* [Display Only viewed entries](https://formviewswp.com/how-to-display-wpforms-starred-viewed-entries-on-site-frontend/?utm_source=wordpress-plugin-repo)
[Get WPForms Views PRO!](https://formviewswp.com/pricing?utm_source=wordpress-plugin-repo)
...
3.3 (24th July 2024)
New: Added support to WPForms Repeater field. Repeater fields are displayed in nicely formatted blocks in View.

3.2.7 (8th June 2024)
New: Changing the View Source will keep the Before and After Entry List Fields in View.
Fix: If there are notices in dashboard View Editor was pushed down making it hard to add fields.

3.2.7 (18th May 2024)
Tweak: Bug Fixes.

3.2.6 (23rd April 2024)
New: Added a new setting to set table column width.
Tweak: Changed pagination widget css class from "pagination" to "views-pagination" to remove possible theme css conflicts.

3.2.5 (4th April 2024)
Fix: Fixed error when using single or double quotes in View Title.
...
2.6.1 (2nd July 2021)
Fix: Sequence number not working correctly if there are multiple views on the page.
